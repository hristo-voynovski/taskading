...
function TaskCard({ task, columnType }: TaskCardProps) {
  const cardStyles = {
    ...
    "in-progress": "bg-yellow-200 hover:bg-yellow-300 dark:bg-yellow-500 dark:hover:bg-yellow-400",
    "for-review": "bg-purple-200 hover:bg-purple-300 dark:bg-purple-500 dark:hover:bg-purple-400",
